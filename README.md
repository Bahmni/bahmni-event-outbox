...
Business Operation
  ...
  OutboxEventService.save()
      ↓
  event_records_queue table (same DB transaction)
```
...
├── model/
│   └── OutboxEvent          # JPA entity mapped to event_records_queue
├── service/
...
The module creates an `event_records_queue` table via Liquibase on startup.
